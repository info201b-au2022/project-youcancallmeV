...
## Conclusion
- Our main focus was to find a efficient way of selecting a suitable college in the United States. To address this concern, we designed a simple tool that allows users to select colleges (colleges/universities included in our database) based on different characteristics (e.g. SAT scores, race population percentage, undergraduate enrollment, etc.)
